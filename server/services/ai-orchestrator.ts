...
function buildSystemPrompt(): string {
  ...
  return [
    ...
    "",
    "CAPTION RULES:",
    "- Always use transcribe_clip to get captions from any video clip with audio (including AI-generated ones).",
    "- NEVER invent or write caption text yourself. Always transcribe the actual audio.",
    "",
